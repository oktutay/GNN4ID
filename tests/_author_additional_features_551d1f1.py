# Verbatim copy of the authors' Utility/Additional_Features.py (GNN4ID upstream commit
# 551d1f1). Used ONLY by the tests to prove the rewritten extractor reproduces it.
import pandas as pd 
import numpy as np
