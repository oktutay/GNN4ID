...
TARGETS = [
    ...
    ("features", "Utility.Additional_Features:compute_rolling_features"),
    ("features", "Utility.Additional_Features:_window_bounds"),
    ("features", "Utility.Additional_Features:_roll"),
    ("split",    "Utility.Functions:split_csv"),
    ("split",    "Utility.Functions:resolve_class_subtype"),
    ("split",    "Utility.Functions:mac_filter"),
    ("combine",  "Utility.Functions:Combining_classes"),
    ("combine",  "Utility.Functions:proportional_cap"),
    ("combine",  "Utility.Functions:oversample_train"),
    ("combine",  "Utility.Functions:build_class8_csvs"),
